        ...
        {selectedFiles.map((file, index) => {
          ...
          return (
            ...
            >
              ...
              <span className="absolute top-1 right-1 text-yellow-600 text-xs font-semibold bg-yellow-100 px-1 rounded">
                Pending
              </span>
            </div>
          );
        ...
        {files.map((file) => {
          ...
          return (
            ...
            >
              ...
              <span className="absolute top-1 right-1 text-green-600 text-xs font-semibold bg-green-100 px-1 rounded">
                Uploaded
              </span>
            </div>
          );
